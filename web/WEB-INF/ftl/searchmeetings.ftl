    ...
    <div class="page-content">
            ...
            <fieldset>
                ...
                <table class="formtable">
                    ...
                    <tr>
                        <td>预定日期：</td>
                        <td colspan="5">
                            从&nbsp;<input type="date" id="reservefromdate"
                                          placeholder="例如：2013-10-20"/>
                            到&nbsp;<input type="date" id="reservetodate"
                    ...
                    <tr>
                        <td>会议日期：</td>
                        <td colspan="5">
                            从&nbsp;<input type="date" id="meetingfromdate"
                                          placeholder="例如：2013-10-20"/>
                            到&nbsp;<input type="date" id="meetingtodate"
                                          placeholder="例如：2013-10-22"/>
                        </td>
                    </tr>
                    <tr>
        ...
        <table class="listtable">
            ...
            <#if meetings ??>
                <#list meetings as ms>
                    <tr>
                        <td>${ms.meetingname}</td>
                        <td>${ms.roomid}</td>
                        <td>${ms.starttime}</td>
                        <td>${ms.endtime}</td>
                        <td>${ms.reservationtime}</td>
                        <td>${ms.reservationistid}</td>
                        <td>
                            <a class="clickbutton" href="/meetingdetails?meetingid=${ms
                            .meetingid}">查看详情</a>
                        </td>
                    </tr>
                </#list>
