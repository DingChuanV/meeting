                    ...
                    <tr>
                        ...
                        <td>
                            <input name="username" type="text" id="accountname"
                                   value="<#if employee??>${employee.username!''}</#if>"
                                   maxlength="20"/>
                        </td>
                        <td>状态：</td>
                        <td>
                            <#if employee??>
                                <#if employee.status==0>
                                    ...
                                    <input type="radio" id="status" name="status" value="0"
                                           checked="checked"/><label>待审批</label>
                                    <input type="radio" id="status" name="status" value="2"/><label>审核未通过</label>
                                ...
                                <#elseif employee.status==2>
                                    ...
                                    <input type="radio" id="status" name="status" value="2"
                                           checked="checked"/><label>审核未通过</label>
                                </#if>
                            <#else>
                                <input type="radio" id="status" name="status" value="1"
                                       checked="checked"/><label>已批准</label>
            ...
            <#if emps??>
                <#list emps as emp>
                    <tr>
                        ...
                        <td>${emp.email}</td>
                        <td>
                            <a class="clickbutton" href="/admin/updateEmpStatus?id=${emp.employeeid}">关闭账号</a>
                        </td>
                    </tr>
                </#list>
            </#if>
