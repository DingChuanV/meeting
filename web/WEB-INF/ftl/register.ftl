            ...
            <fieldset>
                ...
                <table class="formtable" style="width:50%">
                    ...
                    <tr>
                        <td>联系电话：</td>
                        <td>
                            <input name="phone" type="text" id="phone" value="<#if
                            employee??>${employee
                                .phone}</#if>" maxlength="20"/>
                        </td>
                    </tr>
                    <tr>
                        <td>电子邮件：</td>
                        <td>
                            <input name="email" type="text" id="email" value="<#if
                            employee??>${employee.email}</#if>" maxlength="20"/>
                        </td>
                    </tr>
                    <td>所在部门：</td>
                    <td>
